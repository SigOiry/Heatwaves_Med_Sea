...
author:
  ...
  - name: Maria Laura Zoffoli^[Consiglio Nazionale delle Ricerche, Istituto di Scienze Marine (CNR-ISMAR), 00133 Rome, Italy]
    ...
    roles: 
      - Data acquisition
      - Revision
  - name: Christian Marchese^[Consiglio Nazionale delle Ricerche, Istituto di Scienze Marine (CNR-ISMAR), 00133 Rome, Italy]
...
for (i in 343:max(unique(List_HW_csv$doy))) {
...
df1 <- read.csv("Outputs/SST/SST_Phenology/doy/SST_Pheno_DOY_100.csv") %>% 
